...
public class GridFactoryImplNoWalls implements GridFactory {
    ...
    public GridFactoryImplNoWalls(int horizontalTiles, int verticalTiles) throws GridTooSmallException {
