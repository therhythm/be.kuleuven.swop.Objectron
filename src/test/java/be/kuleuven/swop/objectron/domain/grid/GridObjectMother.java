...
public class GridObjectMother {
    ...
    public static Grid gridWithSpecifiedWallsWithoutItemsAndPowerFailures(GridBuilder builder, List<Position> wallPositions) throws GridTooSmallException {
        builder.initGrid(0);
    ...
    public static Grid gridWithSpecifiedWallsPowerFailures(GridBuilder builder, List<Position> wallPositions) throws GridTooSmallException {
        builder.initGrid(0);
    ...
    public static Grid gridWithSpecifiedWallsPowerFailuresItems(GridBuilder builder,  List<Position> wallPositions) throws GridTooSmallException {
        builder.initGrid(0);
        List<Wall> walls = new ArrayList<Wall>();
